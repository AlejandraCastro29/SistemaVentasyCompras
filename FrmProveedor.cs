...
namespace Sistema.Presentacion
{
    public partial class FrmProveedor : Form
    {
        ...
        private void Buscar()
        {
            try
            {
                DgvListado.DataSource = CN_Persona.BuscarProveedores(txtBuscar.Text);//Pasamos el parametro por la caja de texto como string
                this.Formato();
                lbltotal.Text = "Total registros: " + Convert.ToString(DgvListado.Rows.Count);
            }
            catch (Exception ex)
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    Rpta = CN_Persona.Insertar("Proveedor",txtNombre.Text.Trim(), cboTipoDocumento.Text, txtNumDocumento.Text.Trim(),txtDireccion.Text.Trim(),txtTelefono.Text.Trim(),txtEmail.Text.Trim());
                    ...
                    else
                    {
                        ...
                        //No deja ingresar una persona que ya existe.
                    }
                }
            }
            catch (Exception ex)
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Rpta = CN_Persona.Actualizar(Convert.ToInt32(txtId.Text),"Proveedor", this.NombreAnt, txtNombre.Text.Trim(), cboTipoDocumento.Text, txtNumDocumento.Text.Trim(), txtDireccion.Text.Trim(), txtTelefono.Text.Trim(), txtEmail.Text.Trim());
